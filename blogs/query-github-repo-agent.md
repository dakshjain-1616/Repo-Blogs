...
**Onboarding to unfamiliar projects.** Instead of reading a codebase for hours, ask the agent to explain the architecture. Ask what the main entry points are, how the data layer works, what patterns the codebase uses. Get oriented in minutes.
