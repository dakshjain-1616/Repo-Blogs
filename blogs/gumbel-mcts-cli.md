...
NEO built a pure-Python Gumbel-MCTS implementation from the ICLR 2022 paper that runs 10x faster than vanilla UCT with no GPU required and a simple four-method protocol for custom environments. See what else NEO ships at [heyneo.com](https://heyneo.com/).
